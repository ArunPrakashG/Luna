...
pscp -pw miniprakash -v -r .\*.* pi@raspberrypi:/home/pi/Desktop/HomeAssistant/AssistantCore
rem use the following command instead to copy only the project files which is much quicker
rem pscp -pw "miniprakash" -v -r .\AssistantCore.* pi@raspberrypi:/home/pi/Desktop/HomeAssistant/AssistantCore
popd
