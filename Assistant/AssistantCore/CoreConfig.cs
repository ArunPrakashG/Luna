...
namespace HomeAssistant.AssistantCore {
	...
	public class CoreConfig : IEquatable<CoreConfig> {
		...
		[JsonProperty] public string AssistantEmailPASS { get; set; }
		...
		public override int GetHashCode() {
			unchecked {
				...
				hashCode = (hashCode * 397) ^ (AssistantEmailPASS != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(AssistantEmailPASS) : 0);
		...
		public bool Equals(CoreConfig other) {
			...
			return AutoRestart == other.AutoRestart && AutoUpdates == other.AutoUpdates &&
			       ...
			       string.Equals(AssistantEmailPASS, other.AssistantEmailPASS, StringComparison.OrdinalIgnoreCase) &&
