...
using PinMode = HomeAssistant.AssistantCore.Enums.PinMode;
...
namespace HomeAssistant.AssistantCore {
	...
	public class GPIOController {
		...
		private GpioController controllerTest = new GpioController(PinNumberingScheme.Gpio);
		...
		public void TestDeviceController () {
