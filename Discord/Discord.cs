...
namespace Discord {
	public class Discord : IModuleBase, IDiscordBot, IDiscordLogger {
		...
		public static string DiscordBotConfigPath { get; set; } = Constants.ConfigDirectory + "/DiscordBot.json";
		...
		private async Task OnClientReady() {
			await Client.SetGameAsync($"{Core.AssistantName} home assistant!", null, ActivityType.Playing).ConfigureAwait(false);
